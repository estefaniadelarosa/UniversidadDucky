      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
          ...
          {bookFound && (
            <div className="mt-4 flex items-center gap-2 text-green-600">
              ...
              <span className="text-sm font-medium">Libro encontrado - Ahora puedes editar los campos</span>
            </div>
          )}
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
            ...
            <div
              onClick={() => bookFound && fileInputRef.current?.click()}
              className={`border-2 border-dashed border-gray-300 rounded-lg p-12 text-center transition-colors ${
                bookFound ? 'cursor-pointer hover:border-gray-400' : 'cursor-not-allowed opacity-50'
              }`}
            >
              {imagePreview ? (
